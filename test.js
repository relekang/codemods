...
import RemoveIfComponent from './src/RemoveIfComponent';
...
test.only(...generateTest('RemoveIfComponent', RemoveIfComponent, 'remove'));
test(...generateTest('RemoveIfComponent', RemoveIfComponent, 'soft'));
